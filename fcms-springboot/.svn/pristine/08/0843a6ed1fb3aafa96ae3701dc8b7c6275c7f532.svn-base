...
<html lang="en" class="feedback">
	...
	<body>
		<header class="mui-bar mui-bar-nav">
			...
			<h1 class="mui-title">社区新建</h1>
		</header>
		<div class="mui-content">
			<div class="mui-content-padded">
				<div class="mui-inline">想法和心情</div>
			</div>
		...
		var itemId = '${itemId}';
			...
			}).use('upload', _.debounce(function(){
				var $ = layui.jquery,
					upload = layui.upload;
				//上传封面预览
				var uploadInst = upload.render({
					elem: '#uploadImg',
					url: dynamicURL + '/mobile/message/saveUserMessage',
					...
					choose: function(obj) {
						...
						if(data.success) {
							layer.msg('上传成功');
							mui.openWindow({ 
								url: '${dynamicURL}/mobile/activity/main/toActivityCircleDetail', 
								id : 'card.html',
								show:{
