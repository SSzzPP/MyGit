package com.yhlt.showcase.venueUser.controller.main;
 ...
 */
@Controller
@RequestMapping(value = "/venue/main")
public class VenueMainController {
	...
	public String index(HttpServletRequest request, Model model) {
		...
		if (venueUserEntity != null) {
			request.setAttribute("nickName", venueUserEntity.getName());
			return "venuePages/main/index";
		} else {
			return "redirect:/login/venue";
		}
	}

	@RequestMapping("/homePage")
	public String homePage() {
		return "venuePages/main/homePage";
	}
