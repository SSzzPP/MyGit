...
/* #firstMenuCnt li.layui-nav-item.layui-this {
    ...
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left" style="width:60%;" id="firstMenuCnt" lay-filter="component-nav">
          ...
          <li class="layui-nav-item"><a lay-href="${dynamicURL}/venue/information">场馆资讯</a></li>
          <!-- <li class="layui-nav-item layui-hide-xs" lay-unselect>
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" style="margin-right: 8px;" lay-unselect>
            ...
            <dl class="layui-nav-child">
              ...
              <hr>
              <dd layadmin-event="venueLogout" style="text-align: center;"><a>退出</a></dd>
            </dl>
          </li>
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          <div class="layui-logo" lay-href="${dynamicURL}/venue/main/homePage">
            <span>全民共享健身平台</span>
          </div>
      ...
      <div class="layadmin-pagetabs" id="LAY_app_tabs">
        ...
        <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
          <ul class="layui-tab-title" id="LAY_app_tabsheader">
            <li lay-id="${dynamicURL}/venue/main/homePage" lay-attr="${dynamicURL}/admin/main/homePage" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
          </ul>
        </div>
      </div>
  ...
  <script>
  	function edit() {
  		var url = "${dynamicURL}/venue/user/toPassword";
  		_layer({
    	  	url:url,
    	  	title:"修改密码",
    	  	btn: ['保存', '取消'],
