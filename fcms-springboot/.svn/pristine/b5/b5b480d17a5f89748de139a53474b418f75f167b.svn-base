 ...
 */
@Controller
@RequestMapping(value = "/front/survey/paperQuestion")
public class FrontSurveyPaperQuestionController extends BaseController<SurveyPaperQuestionEntity, SurveyPaperQuestionService> {
	@Autowired
...
//	}
	...
	@RequestMapping(value = "/toSurveyQuestionTotal")
	public String toSurveyQuestionTotal (Long paperId,String paperTitle, Long total, Long actual, HttpServletRequest request) {
		request.setAttribute("paperId", paperId);
		request.setAttribute("paperTitle", paperTitle);
		request.setAttribute("total", total);
		request.setAttribute("actual", actual);
		return "/survey/surveyQuestionTotal";
	}
	...
	public Map<String,Object> questionList(
		...
		result.put("paperId", paperQuestionEntities.get(0).getSurveyPaperEntity().getId());
		result.put("paperName", paperQuestionEntities.get(0).getSurveyPaperEntity().getTitle());
		return result;
	}
	// 添加考试题目
