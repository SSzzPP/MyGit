...
(function ($) {
    ...
    function _63b(_63c, _63d) {
        ...
        _645.find("div.datagrid-cell").addClass("datagrid-sort");
        for (var i = 0; i < _640.length; i++) {
            var col = _614(_63c, _640[i]);
            _645.find("div." + col.cellClass).removeClass("datagrid-sort");
            _645.find("div." + col.cellClass).removeClass("datagrid-sort-asc datagrid-sort-desc");
