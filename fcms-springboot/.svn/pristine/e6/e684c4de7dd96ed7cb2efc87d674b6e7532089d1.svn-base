...
$(function() {
    ...
    venueDatagrid = $('#venueDatagrid').datagrid({
    	url: '${dynamicURL}/admin/venue/equipment/type/list?sort=gmtCreate&order=desc&search_EQ_publicFlag=1',
        ...
        columns: [
            [
                ...
                {field: 'venueName', title: '健身场馆',width:'15%', sortable: true,align:'left'},
                ...
                {field: 'businessHours', title: '营业时间',width:'10%', sortable: true},
                {field: 'description', title: '项目描述',width:'10%', sortable: true},
                {field: 'floor', title: '地板',width:'10%', sortable: true},
                {field: 'lighting', title: '灯光',width:'10%', sortable: true},
                {field: 'restingArea', title: '休息区',width:'10%', sortable: true}
            ]
        ],
...
function add() {
	parent._layer({
        url: '${dynamicURL}/admin/venue/equipment/type/add',
        title: "新增设施",
        width:'600px',
        height:'600px',
        btn: ['保存', '取消']
...
function edit() {
	...
	if(row){
		parent._layer({
	        url: '${dynamicURL}/admin/venue/equipment/type/add?id='+row.id,
	        title: "修改设施",
	        width:'600px',
	        height:'600px',
	        btn: ['保存', '取消']
