...
public class MainController {
	...
	public String toCard () {
		return "/system/main/card";
	}
	
	@RequestMapping(value = "/toActivity")
	public String toActivity () {
		return "/system/main/activity_circle";
	}
	...
	public String toUserMap () {
		return "/system/main/userMap";
	}
