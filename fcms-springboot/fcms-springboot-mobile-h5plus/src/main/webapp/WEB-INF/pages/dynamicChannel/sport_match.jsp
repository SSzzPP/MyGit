...
<html>
	...
	<jsp:param name="sport_match" value="mui-active"/>
	</jsp:include>
		<meta charset="utf-8">
			...
			<div class="mui-slider mui-fullscreen" style="top:82px;overflow:auto;">
				<div class="mui-scroll" id="pullRefresh">
					...
					<%-- <ul class="mui-table-view list">
						<li class="mui-table-view-cell" uuid="'+item.uuid+'">
							<img class="mui-pull-left" src="${staticURL}/images/front/venuetu1.png">
							<div class="siteInfo">
								<div class="siteName">体育赛事</div>
								<div class="con"><span>2018-09-03</span></div>
							</div>
						</li>
						<li class="mui-table-view-cell" uuid="'+item.uuid+'">
							<img class="mui-pull-left" src="${staticURL}/images/front/venuetu1.png">
