...
public class CustomServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		// UEditor
		servletContext.setAttribute("ueditorHomeUrl", envProperties.getHomeUrl());
		servletContext.setAttribute("urlPrefix", envProperties.getUrlPrefix());
		servletContext.setAttribute("imagePathFormat", envProperties.getImagePathFormat());
		servletContext.setAttribute("videoPathFormat", envProperties.getVideoPathFormat());
    }
