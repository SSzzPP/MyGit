...
@Controller
@RequestMapping(value = "/front/activity/user")
public class FrontActivityMainUserController extends BaseController<ActivityMainUserEntity, ActivityMainUserService> {
