...
import com.yhlt.showcase.system.service.GradeService;
/**
 ...
 */
@Controller
@RequestMapping(value = "/admin/system/grade")
public class GradeController extends BaseController<GradeEntity, GradeService> {

	@Override
	public String index(Model model) {
		return "system/grade_index";
	}
