				...
				<form class="form-horizontal" for="venueDatagrid">
					<table style="width: 800px; line-height: 40px;">
						<tr>
							...
							<td>类型:</td>
							<td>
								<input class="easyui-textbox" type="text" name="search_LIKE_type" style="width: 150px; height: 26px">
							</td>
							<td>
	        ...
	        columns: [[
		        ...
		        },
		        {
		            ...
		            formatter: function Ra(val, row, index) {
		            	return '<a lay-href="${dynamicURL}/admin/manage/info/toVenue?venueId='+row.id+'"><button class="layui-btn">场馆详情</button></a>';	
		            }
		        }
	        ]],
