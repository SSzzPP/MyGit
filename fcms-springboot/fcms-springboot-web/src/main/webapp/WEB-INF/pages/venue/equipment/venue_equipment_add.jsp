			...
			<div title="场馆基本信息" style="padding: 5px;">
				<table class="table_edit" style="text-align: center;">
					...
					<tr>
						...
						<td>
							<textarea class="form-control" type="text" name="businessHours" style="width: 270px; height: 52px;">${entity.businessHours}</textarea>
						</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="text_tr" >地板：</td>
						<td>
							<input class="form-control" type="text" name="floor" value="${entity.floor }" style="width: 270px; height: 26px" /><span></span>
						</td>
						<td></td>
					</tr>
					<tr>
						<td class="text_tr" >灯光：</td>
						<td><input class="form-control" type="text" name="lighting" value="${entity.lighting }" style="width: 270px; height: 26px" /><span></span>
						</td>
						<td></td>
					</tr>
					<tr>
						<td class="text_tr" >休息区：</td>
						<td><input class="form-control" type="text" name="restingArea" value="${entity.restingArea }" style="width: 270px; height: 26px" /><span></span>
						</td>
						<td></td>
					</tr>
					<tr>
