		...
		<form class="addForm" id="addForm"  method="post" action="" enctype ="multipart/form-data">
			...
			<div title="场馆基本信息" style="padding: 5px;">
				<table class="table_edit" style="text-align: center;">
					...
					<tr>
						<td colspan="3" ><span style="color:#f00;float:left;">*仅支持.gif，.bmp，.png，.jpg，.jpeg格式的图片上传</span></td>
					</tr>
					<tr>
						<td class="text_tr" >视频：</td>
						<td>
							<input type="file" name="video" style="width: 270px; height: 26px;">  
						</td>
						<td></td>
					</tr>
					<tr>
						<td colspan="3" ><span style="color:#f00;float:left;">*仅支持.mp4格式的视频上传</span></td>
					</tr>
				</table>
			</div>
		</form>
